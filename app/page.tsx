      ...
      <main className="">
        ...
        <section className="gradient-hero min-h-[90vh] flex items-center relative overflow-hidden">
          <div
            ...
            style={{
              backgroundImage:
                "radial-gradient(circle at 70% 50%, #fed65b 0%, transparent 60%)",
            }}
          />
          <div className="max-w-7xl mx-auto px-6 lg:px-8 py-24 lg:py-32 relative z-10">
            <div className="max-w-3xl">
              ...
              <div
                ...
                style={{
                  backgroundColor: "rgba(254,214,91,0.15)",
              ...
              >
                Build Your Elite{" "}
                <span style={{ color: "#fed65b" }}>Remote Team</span> Today.
              </h1>

              <p className="text-lg lg:text-xl text-white/70 leading-relaxed mb-10 max-w-2xl">
                Connect with high-performance Filipino professionals —
                pre-trained, rigorously vetted, and ready to integrate
                seamlessly into your business from day one.
              </p>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <p className="text-base text-[#44464f] leading-relaxed mb-10">
                  We don&apos;t just find employees; we build high-capacity
                  infrastructure. Our talent pool is meticulously selected and
                  pre-trained to integrate seamlessly into your established
                  workflows.
                </p>
                <ul className="space-y-5">
                  {[
                    ...
                    <li key={item.title} className="flex items-start gap-4">
                      ...
                      />
                      <div>
                        <div className="font-semibold text-[#1a1b20] text-sm">
                          {item.title}
                        </div>
                        <div className="text-sm text-[#44464f]">
                          {item.desc}
                        </div>
                      </div>
                    </li>
                ...
                {[
                  {
                    ...
                    label: "Revenue-Conscious Teams",
                    value: "40%",
                    sub: "higher retention rate",
                  },
                  {
                    icon: <Shield size={28} />,
                  ...
                  >
                    <div className="mb-3" style={{ color: "#00113a" }}>
                      {card.icon}
                    </div>
                    <div
                    ...
                    <div className="text-xs font-semibold text-[#1a1b20] mb-0.5">
                      {card.label}
                    </div>
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-base text-[#44464f] max-w-xl mx-auto">
                Tailored talent acquisition across key functional departments to
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <p className="text-white/70 text-base leading-relaxed">
                  Typical outsourcing is a revolving door of talent. Aeternum is
                  built on the philosophy of &ldquo;Architectural
                  Longevity.&rdquo; We focus on high retention and deep
                  integration &mdash; not just placement.
                </p>
              </div>
        ...
        <section className="gradient-hero py-24 lg:py-32">
          <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
            ...
            <p className="text-base text-white/70 leading-relaxed mb-10 max-w-2xl mx-auto">
              Join dozens of industry leaders who have scaled their operations
              with Aeternum&apos;s premium talent solutions.
            </p>
