              ...
              {testimonials.map((t) => (
                ...
                >
                  <div className="flex gap-1 mb-6">
                    {[...Array(5)].map((_, i) => (
                      <Star key={i} size={16} fill="#fed65b" style={{ color: "#fed65b" }} />
                    ))}
                  </div>
                  <blockquote className="text-base text-[#1a1b20] leading-relaxed mb-8 italic">
                    &ldquo;{t.quote}&rdquo;
                  </blockquote>
                  <div>
                    <div className="font-semibold text-[#00113a]" style={{ fontFamily: "var(--font-manrope)" }}>
                      {t.name}
                    </div>
                    <div className="text-sm text-[#44464f]">{t.title}</div>
                  </div>
                </div>
              ))}
            </div>
